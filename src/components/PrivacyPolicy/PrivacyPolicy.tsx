  ...
  return (
    <div className="PrivacyPolicy_container">
      ...
      <p className="PrivacyPolicy_description">
        ...
        use: Session Cookies. We use Session Cookies to operate our Service.
      ...
      <p className="PrivacyPolicy_description">
        ...
        represents your agreement to that transfer. ImagesSlider will take all
      ...
      <p className="PrivacyPolicy_description">
        ...
        <br />
        To protect and defend the rights or property of ImagesSlider
        <br />
      ...
      <p className="PrivacyPolicy_description">
        ...
        <br />
        By email: contact@imagesslider.com
      </p>
    </div>
  );
};
